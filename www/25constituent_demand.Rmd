...
mort_tbl <- mort %>%
  gt::gt() %>%
  gt::tab_header(
    title = "Table 4. Choke scores applied based the percent of the projected ACL attainment given current average catches by species."
  ) %>%
  gt::cols_align(
    align = "left"
  )
